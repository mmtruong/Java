...
public class Court extends A3ButtonHandler
{
    ...
    public final int BOTTOM_LINE = 425;
    ...
    {   
        ...
        carA = new Car( 6, 6, Color.green, false, window, this );
        carB = new Car( 100, 100, Color.red, true, window, this );
    ...
    public Car getOtherCar(Car movingCar){
        if(movingCar==carA){return carB;}//returns other car if this car is selcted
        else{return carA;}
    ...
    public void midAction(){
       if( carA.isSelected()){//if this car is selected then apple advance direction method when clicked
