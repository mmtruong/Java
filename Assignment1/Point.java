...
/*
a. Mike Truong, CSC142, Assignment1, 4/8/10
b. 6 (double)
c. (0,4)   In detail: private double x = 0, private double y = 4
d. Point point1 = new Point( 3, 4 );
e. point1.getX()
f.	There are two ways to store the distance into variable dist:
	1. double dist;
	dist=point2.distance(point1);
	2. double dist=point2.distance(point1);
g. Point mid = point1.midPoint(point2);
*/
